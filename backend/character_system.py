...
CHARACTER_CATEGORIES = {
    ...
    "banana_pros": {
        "name": "바나나 프로",
        "description": "변신의 귀재들! 10명의 바나나 프로 친구들",
        "count": 10,
        "characters": [
            {"id": "banana_king", "name": "バナナキング", "kr_name": "바나나 킹", "type": "왕", "personality": "위엄있는", "img": "🍌👑"},
            {"id": "banana_ninja", "name": "バナナ忍者", "kr_name": "바나나 닌자", "type": "닌자", "personality": "날렵한", "img": "🍌🥷"},
            {"id": "banana_robot", "name": "バナナロボ", "kr_name": "바나나 로봇", "type": "로봇", "personality": "똑똑한", "img": "🍌🤖"},
            {"id": "banana_cat", "name": "バナナ猫", "kr_name": "바나나 냥", "type": "고양이", "personality": "귀여운", "img": "🍌🐱"},
            {"id": "banana_ghost", "name": "バナナお化け", "kr_name": "바나나 유령", "type": "유령", "personality": "장난꾸러기", "img": "🍌👻"},
            {"id": "banana_baby", "name": "ベビーバナナ", "kr_name": "베이비 바나나", "type": "아기", "personality": "응석받이", "img": "🍌👶"},
            {"id": "banana_grandpa", "name": "バナナじい", "kr_name": "바나나 할배", "type": "노인", "personality": "지혜로운", "img": "🍌👴"},
            {"id": "banana_muscle", "name": "マッスルバナナ", "kr_name": "근육 바나나", "type": "헬창", "personality": "강력한", "img": "🍌💪"},
            {"id": "banana_wizard", "name": "バナナ魔法使い", "kr_name": "바나나 마법사", "type": "마법사", "personality": "신비로운", "img": "🍌🧙‍♂️"},
            {"id": "banana_zombie", "name": "バナナゾンビ", "kr_name": "바나나 좀비", "type": "좀비", "personality": "배고픈", "img": "🍌🧟"}
        ]
    },
    "professionals": {
        "name": "전문가",

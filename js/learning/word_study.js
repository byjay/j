...
// Hook into init
const originalInitVocabulary = window.initVocabulary || function () { };
window.initVocabulary = async function () {
    await loadWordData();
    if (typeof originalInitVocabulary === 'function') originalInitVocabulary();
};

/* 
 * Legacy static data structure reference or fallback 
 * (Currently commented out or removed as we rely on API)
 */
// const wordData = { ... }

...
function initNaraTrip() {
    console.log('✨ Nara App V6.0 Loaded [DEEP DATA]');

    // ==========================================================================
    //  ✨ HIGH FIDELITY DATABASE: NARA
    // ==========================================================================
    const POI_DATABASE = [
    {
        "id": "nara_park",
    ...
    // ==========================================================================
    let userItinerary = {"1": ["nara_park", "todaiji", "mochi"], "2": ["kasuga_taisha", "higashimuki"], "3": ["nara_park"], "4": ["higashimuki"]};
    let activeDay = 1;
    let map, markers = [];
...
window.initNaraTrip = initNaraTrip;

...
function initKyotoTrip() {
    ...
    const POI_DATABASE = [
        // --- 1일차 ---
        {
            ...
            details: {
                info: "하루카 편도 티켓을 미리 예매하면 저렴합니다(약 1,800엔). 교토역에 도착하면 교토 타워 야경부터 보세요.",
                transport: `<p class="text-xs text-gray-600">🚆 하루카 특급열차 예매 추천</p>`
            }
        },
        {
            ...
            details: { info: "역과 연결되어 있어 비 오는 날도 이동이 편합니다. 교토 타워 뷰 객실을 요청해보세요." }
        },
        {
            ...
            details: { info: "해 질 녘에 가면 붉은 등불이 켜져 분위기가 좋습니다. 폰토초 좁은 골목의 이자카야에서 한잔 추천." }
        },
        ...
        // --- 2일차 ---
        {
            ...
            details: { info: "아침 7시 이전에 가야 사람 없이 사진 찍을 수 있습니다. 내려올 때 산넨자카/니넨자카 계단 조심하세요." }
        },
        {
            ...
            details: { info: "정상까지는 왕복 2시간 등산 코스입니다. 힘들면 중간 '요쓰쓰지' 전망대까지만 가도 충분히 멋집니다." }
        },
        ...
        // --- 3일차 ---
        {
            ...
            details: { info: "무조건 아침 일찍(9시 전) 가야 합니다. 텐류지 북문으로 나가면 바로 연결됩니다." }
        },
        {
            ...
            details: { info: "해가 쨍할 때 가야 금빛이 번쩍번쩍해서 예쁩니다. 연못에 비친 반영 사진이 포인트." }
        },
        ...
        // --- 4일차 ---
        {
            ...
            details: { info: "'타코타마고(쭈꾸미 꼬치)'는 꼭 먹어보세요! 스누피 차야 등 캐릭터 샵도 많습니다." }
        }
    ];
    ...
    window.showDetail = function (id) {
        ...
        content.innerHTML = `
            ...
            <div class="sticky top-0 bg-white z-10 flex border-b shadow-sm">
                <button class="flex-1 py-4 text-sm font-bold text-amber-600 border-b-2 border-amber-600 transition">개요</button>
            ...
            <div class="p-6 pb-24 space-y-8">
                ...
                <div class="bg-gray-50 p-5 rounded-2xl border border-gray-100">
                    <h3 class="font-bold text-gray-800 text-sm mb-3 flex items-center gap-2">
                        <i class="fas fa-info-circle text-amber-500"></i> 상세 정보
                    </h3>

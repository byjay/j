...
function initOkinawaTrip() {
    ...
    const POI_DATABASE = [
        // --- 교통 & 공항 ---
        {
            ...
            details: {
                info: "국제선과 국내선이 연결되어 있습니다. 편의점, 식당, 기념품샵은 국내선 터미널이 훨씬 크고 다양합니다. 포크타마고 오니기리 공항점은 줄이 기니 주의하세요.",
                transport: `
                    <div class="space-y-2">
                        <div class="p-2 bg-blue-50 rounded border border-blue-200">
                            <strong>🚝 유이레일(모노레일):</strong> 공항 2층 연결. 시내(국제거리)까지 15분.
                        </div>
        ...
        // --- 나하 시내 (Naha) ---
        {
            ...
            details: {
                info: "일요일 낮(12:00~18:00)은 보행자 천국으로 차가 다니지 않아 걷기 좋습니다. 돈키호테, 샘스 스테이크 등 유명 가게가 즐비합니다.",
                transport: `<p class="text-xs text-gray-600">🚝 유이레일 겐초마에역 또는 마키시역 하차</p>`
            }
        },
        {
            ...
            details: { info: "1층에서 생선을 사고 2층 식당가에서 조리비(500엔)를 내고 먹는 시스템입니다. 현지 분위기를 느끼기에 최고입니다." }
        },
        {
            ...
            shop_keyword: '양산',
            details: {
                info: "화재로 정전이 소실되었으나 복원 과정을 공개하고 있어 교육적 가치가 높습니다. 꽤 많이 걸어야 하니 편한 신발을 신으세요.",
                transport: `<p class="text-xs text-gray-600">🚝 유이레일 슈리역 하차 후 도보 15분 (또는 버스 환승)</p>`
            }
        },
        {
            ...
            details: { info: "스프와 샐러드가 무한리필 됩니다. '텐더로인' 부위가 가장 부드럽고 인기가 많습니다. 블루씰 아이스크림도 팝니다." }
        },
        {
            ...
            details: { info: "수영장이 작지만 알찹니다. 조식 뷔페 '사쿠라자카'가 매우 유명하니 꼭 드세요. 국제거리 접근성이 최고입니다." }
        },

        // --- 중부 (Middle) ---
        {
            id: 'american', name: '아메리칸 빌리지', lat: 26.3165, lng: 127.7577, type: 'spot', region: 'middle', rating: 4.6,
            desc: '미국 서부 해안 분위기. 쇼핑과 맛집의 천국.',
            photos: ['https://images.unsplash.com/photo-1599577742099-0b73461461a6?w=800'],
            shop_keyword: '선글라스',
            details: {
                info: "낮보다 밤이 훨씬 예쁩니다. 선셋 비치에서 일몰을 보고 야경을 즐기세요. 포켓몬 벽화가 곳곳에 숨어있으니 찾아보세요.",
                transport: `<p class="text-xs text-gray-600">🚌 나하 버스터미널에서 20/28/29/120번 버스 (약 40분)</p>`
            }
        },
        {
            ...
            shop_keyword: '바람막이',
            details: {
                info: "드라마 '괜찮아 사랑이야' 촬영지. 바람이 매우 강하게 부니 모자가 날아가지 않게 주의하세요. 산책로는 20분이면 충분합니다.",
                transport: `<p class="text-xs text-gray-600">🚗 렌트카 이용 추천 (주차장 완비)</p>`
            }
        },
        {
            ...
            details: { info: "메인 로비의 거대 수조가 포토존입니다. 1층 면세 카운터 위치를 미리 파악하세요. 포켓몬 센터도 있습니다." }
        },
        {
            ...
            details: { info: "자색고구마(베니이모) 맛과 소금우유(친스코) 맛이 가장 인기 있습니다. 레트로한 인테리어가 사진 찍기 좋습니다." }
        },
        ...
        // --- 북부 (North) ---
        {
            ...
            details: {
                info: "세계 최대급 수조 '쿠로시오의 바다' 앞 카페 자리는 오픈런 필수입니다. 오키짱 극장(돌고래쇼)은 무료입니다.",
                ticket: `<p class="text-xs text-gray-600">🎫 쿄다 휴게소에서 할인 티켓 구매 추천</p>`,
                transport: `<p class="text-xs text-gray-600">🚌 얀바루 급행버스 (나하공항/시내에서 직행)</p>
                            <p class="text-xs text-gray-600">🚗 렌트카 이용 시 약 2시간 소요</p>`
            }
        },
        {
            ...
            shop_keyword: '아쿠아슈즈',
            details: { info: "다리 건너기 전 주차장에서 다리를 배경으로 사진을 찍으세요. 코우리 슈림프 웨건은 대기가 기니 미리 주문하세요." }
        },
        {
            ...
            shop_keyword: '모기기피제',
            details: { info: "모기가 많으니 기피제 필수. 자전거 대여료는 보통 500엔입니다. 바다로 이어지는 길이 예쁩니다." }
        },
        {
            ...
            shop_keyword: '아이 간식',
            details: { info: "파인애플 송이째로 파는 것보다 컷팅된 과일이나 빵이 선물용으로 좋습니다. 파인애플 와인 시음도 가능합니다." }
        },
        {
            ...
            details: { info: "메뉴는 소바와 영양밥(쥬시) 뿐입니다. 재료 소진 시 일찍 문 닫으니 점심에 가세요." }
        },
        ...
        // --- 남부 (South) ---
        {
            ...
            shop_keyword: '셀카봉',
            details: {
                info: "그늘이 거의 없어 낮에는 덥습니다. 선셋 타임에 팬케이크(시아와세) 먹는 것을 추천합니다. 무료 셔틀버스가 있습니다.",
                transport: `<p class="text-xs text-gray-600">🚌 아카미네역에서 무료 셔틀버스 운행</p>`
            }
        },
        {
            ...
            details: { info: "동굴 안은 습하고 미끄러우니 편한 신발을 신으세요. 에이사 공연 시간 맞춰 가세요. 류큐 왕국촌 체험도 재밌습니다." }
        },
        {
            ...
            details: { info: "카레가 꽤 맵습니다. 야외석은 식사 불가하고 사진 촬영만 가능할 수 있습니다. 웨이팅이 깁니다." }
        },
        {
            ...
            shop_keyword: '방수팩',
            details: { info: "상업화가 덜 되어 조용합니다. 글라스 보트로 니모를 볼 수 있습니다. 물이 정말 맑습니다." }
        },
        {
            ...
            details: { info: "투숙객이 아니어도 온천만 이용 가능합니다(유료). 선셋 타임 노천탕이 최고입니다. 서서 온천을 즐기는 '타치유'가 유명합니다." }
        }
    ];
                    ...
                    <div class="space-y-4 animate-fade-in">
                        <div class="flex items-center gap-4 mb-6 bg-teal-50 p-4 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">방문자 리뷰 500+개</p>
                            </div>
                        </div>
                        <div class="border-b border-gray-100 pb-4">
                            <div class="flex justify-between mb-2"><span class="font-bold text-sm">바다거북</span><span class="text-xs text-gray-400">1일 전</span></div>
                            <div class="text-yellow-400 text-xs mb-2">★★★★★</div>
                            <p class="text-sm text-gray-600">바다 색깔이 정말 예술입니다. 힐링 그 자체!</p>
                        </div>
                        <div class="border-b border-gray-100 pb-4">
                            <div class="flex justify-between mb-2"><span class="font-bold text-sm">스테이크러버</span><span class="text-xs text-gray-400">4일 전</span></div>
                            <div class="text-yellow-400 text-xs mb-2">★★★★☆</div>
                            <p class="text-sm text-gray-600">가성비 좋고 맛있어요. 분위기도 좋습니다.</p>
                        </div>
                    </div>`;
